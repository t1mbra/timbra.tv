  ...
  function CompactSwitch(
    ...
    return (
      <button
        ...
        className={[
          "relative inline-flex shrink-0 cursor-pointer items-center rounded-full p-0.5 align-middle transition-[background-color,box-shadow,opacity,ring-color,ring-offset-color] duration-200 ease-[cubic-bezier(0.2,0.8,0.2,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[rgba(9,9,15,0.96)] disabled:cursor-not-allowed disabled:opacity-40 motion-reduce:transition-none",
